...
class TokenCounter:
    ...
    def token_limit(model: str = "gpt-3.5-turbo-0301") -> int:
        try:
            model_token_limit_dict = {"gpt-3.5-turbo-0301": 4032, "gpt-4-0314": 8092, "gpt-3.5-turbo": 4032, "gpt-4": 8092,"gpt-3.5-turbo-16k": 16184, "gpt-3.5-turbo-0613": 4032}
    ...
    def count_message_tokens(messages: List[BaseMessage], model: str = "gpt-3.5-turbo-0301") -> int:
        try:
            model_token_per_message_dict = {"gpt-3.5-turbo-0301": 4, "gpt-4-0314": 3, "gpt-3.5-turbo": 4, "gpt-4": 3,"gpt-3.5-turbo-16k":4, "gpt-3.5-turbo-0613": 4}
